    ...
    <main style={{ maxWidth: 1100, margin: "0 auto", padding: "48px 24px 80px" }}>
      ...
      {visibleSeries.length > 0 && (
        <section style={{ marginBottom: 32 }}>
          <div style={{ position: "relative", maxWidth: 420, marginBottom: allGenres.length ? 14 : 0 }}>
            ...
            <input value={query} onChange={e => setQuery(e.target.value)} placeholder="Search series…"
              style={{ width: "100%", background: "var(--surface)", border: "1px solid var(--hairline)", color: "var(--paper)", padding: "11px 14px 11px 38px", borderRadius: 999, fontSize: 14 }} />
          </div>
          {allGenres.length > 0 && (
